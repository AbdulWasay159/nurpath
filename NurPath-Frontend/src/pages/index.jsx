...
import { Moon, BookMarked, BarChart2, Bell, Shield, Compass } from 'lucide-react';
...
const features = [
  ...
  { icon: BookMarked, title: 'Morning & Evening Adhkar', desc: 'Authentic adhkar with Arabic, translation, transliteration, and fixed repetition counts.' },
  ...
  { icon: Compass, title: 'Qibla Finder', desc: 'Find the direction of the Kaaba wherever you are, using your device compass.' },
  { icon: Bell, title: 'Announcements', desc: 'Stay informed with admin-broadcast notifications and reminders.' },
  { icon: Shield, title: 'Role-Based Accounts', desc: 'User and Admin roles, so your community can be kept up to date securely.' },
];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-6 py-24">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          ...
          <div className="max-w-lg mx-auto mb-8 px-6 py-4 rounded-2xl"
            ...
            <p className="font-amiri text-lg italic" style={{ color: 'var(--gold-light)' }}>"{QUOTES[0].text}"</p>
            <p className="text-xs mt-2 uppercase tracking-widest" style={{ color: 'var(--text-muted)' }}>— {QUOTES[0].source}</p>
          </div>

          <p className="text-lg max-w-xl mx-auto mb-10" style={{ color: 'var(--text-secondary)' }}>
            A focused Salah and Adhkar companion to help you build consistent, mindful worship habits.
          </p>
      ...
      <section className="px-6 py-20 text-center">
        <div className="max-w-lg mx-auto p-10 rounded-3xl"
          ...
          <p className="text-sm mb-6" style={{ color: 'var(--text-secondary)' }}>Free to use. No ads. Pure niyyah.</p>
          <Link href="/register"
      ...
      {/* Footer */}
      <footer className="text-center py-8 border-t" style={{ borderColor: 'rgba(201,168,76,0.06)', color: 'var(--text-muted)' }}>
